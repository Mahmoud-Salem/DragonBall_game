...
public class DragonWish extends EventObject {
	...
	{
		if(type.equals(DragonWishType.SENZU_BEANS))
		{
			return senzuBeans+" of Senzu Beans";
		}
		else if(type.equals(DragonWishType.ABILITY_POINTS))
		{
			return abilityPoints+" of Ability Points";
		}
		else if(type.equals(DragonWishType.SUPER_ATTACK))
		{
			return "Super Attack : "+superAttack.getName();
		}
		else 
		{
			return "Ultimate Attack : "+ultimateAttack.getName();
		}
	}
